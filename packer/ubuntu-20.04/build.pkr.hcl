...
build {
  ...
  provisioner "shell-local" {
    environment_vars = [
      ...
      #"ansible_inv_host_alias={{ .HostAlias }}",
      #"ansible_inv_host={{ .Host }}",
      "ansible_inv_user=${var.ssh_username}",
      #"ansible_inv_port={{ .Port }}"
    ]
  ...
  #  #ansible_env_vars = [
  #  #  "ANSIBLE_CONFIG=${var.launch_home}/ansible.cfg",
  ...
  #  #inventory_file = "${var.launch_home}/inventory.ini"
